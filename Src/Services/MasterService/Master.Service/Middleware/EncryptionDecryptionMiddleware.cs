...
namespace Master.Service.Middleware
{
    public class EncryptionDecryptionMiddleware
    {
        ...
        //    try
        //    {
        //        // ✔ IMPORTANT: allow body to be read again later (fix 415)
        ...
        //                // ✔ Reset body position for further reading (fix 415)
        //                context.Request.Body.Position = 0;
        ...
        //                        jsonData["data"] == null ? "" : Convert.ToString(jsonData["data"].Value<string>());

        //                    if (!string.IsNullOrEmpty(secretDataKey))
        //                    {
        //                        string decryptedPayload =
        //                            EncryptionDecryptionExtension.Decrypt(secretDataKey, _secretKey);
        //                        var requestheader = JsonConvert.SerializeObject(context.Request.Headers);
        ...
        //                            // ✔ Reset stream to allow model-binding to read (fix 415)
        //                            context.Request.Body.Position = 0;
        //                        }
        //                        else
        //                        {
        ...
        //                        // ✔ Set required headers (fix 415 for response)
