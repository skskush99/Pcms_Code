...
using CaseService.Extension;
using Case.ServiceBus;
...
//app.UseMiddleware<CaseService.Middleware.EncryptionDecryptionMiddleware>(); //open in future if needed Decryption
...
//app.UseUserContext();
////middleware for encryption
//app.UseMiddleware<CaseService.Middleware.EncryptionDecryptionMiddleware>();
//app.MapControllers();
//app.Run();